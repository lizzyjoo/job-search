    ...
    <div className="flex flex-col md:flex-row gap-4 mb-6">
      <div className="relative center flex">
        <select
          ...
          className="text-xl appearance-none bg-neutral-100 rounded-3xl p-2 pr-8 w-full md:w-auto"
        >
      ...
      <div className="relative w-full md:flex-1 ">
        <input
          ...
          className="rounded-3xl block w-3/5 p-3 ps-9 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body"
        />
